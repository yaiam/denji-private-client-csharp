...
namespace Kochnev.Auth.Private.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.0.0-alpha01";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.0-alpha01/csharp");
        ...
        {
            string report = "C# SDK (Kochnev.Auth.Private.Client) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0\n";
            report += "    SDK Package Version: 1.0.0-alpha01\n";
